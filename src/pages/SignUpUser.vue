        ...
        <div class="registration-container">
            ...
            <div class="registration-form">
                <div class="input-field">
                    ...
                    <input type="text" id="lastName" v-model="lastName" placeholder="Ex: Benzarti">
                </div>
                <div class="input-field">
                    <label for="firstName">First Name</label>
                    <input type="text" id="firstName" v-model="firstName" placeholder="Ex: Nour">
                </div>
                <div class="input-field">
                    <label for="email">Email</label>
                    <input type="email" id="email" v-model="email" placeholder="Ex: example@example.com">
                </div>
                <div v-if="userType === 'fleetOwner'" class="input-field">
                ...
                <div class="input-field dob-fields">
                    <label>Date of Birth</label>
                    <v-row class="green-selection">
                        <v-col cols="4">
                            <v-select v-model="selectedDay" :items="days" label="Day" required
                                class="text-green"></v-select>
                        </v-col>
                        <v-col cols="4">
                            <v-select v-model="selectedMonth" :items="months" label="Month" required
                                class="text-green"></v-select>
                        </v-col>
                        <v-col cols="4">
                            <v-select v-model="selectedYear" :items="years" label="Year" required
                                class="text-green"></v-select>
                        </v-col>
                    </v-row>
                </div>
