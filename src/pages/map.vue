        ...
        <div v-if="popupVisible" class="popup" :style="{ left: popupPosition.x + 'px', top: popupPosition.y + 'px' }">
            <div class="popup-content">
                <div class="popup-left">
                    <img src="../assets/bike1.png" alt="Another Image" class="top-image" />
                </div>
...
import customPinIcon from "@/assets/bike1.png";
...
.popup-left {
    ...
    position: relative;
    background-image: url("../assets/bike1.png");
    user-select: none;
...
.popup-right {
    ...
    background-image: url("../assets/bike_bkg.png");
...
.small-text {
    font-size: 1em;
    /* Font size relative to parent container */
}
